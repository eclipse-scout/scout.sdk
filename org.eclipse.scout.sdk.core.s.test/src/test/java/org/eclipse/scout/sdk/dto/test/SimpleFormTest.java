...
public class SimpleFormTest {
  ...
  private static void testApiOfSimpleFormData(IType simpleFormData) {
    ...
    Assert.assertEquals("field count of 'SimpleFormData'", 1, simpleFormData.getFields().size());
    IField serialVersionUID = SdkAssert.assertFieldExist(simpleFormData, "serialVersionUID");
    SdkAssert.assertHasFlags(serialVersionUID, 26);
    SdkAssert.assertFieldSignature(serialVersionUID, "J");

    Assert.assertEquals("method count of 'SimpleFormData'", 11, simpleFormData.getMethods().size());
    ...
    Assert.assertEquals("inner types count of 'SimpleFormData'", 8, simpleFormData.getTypes().size());
    // type Date
    ...
    // fields of Date
    Assert.assertEquals("field count of 'Date'", 1, date.getFields().size());
    IField serialVersionUID1 = SdkAssert.assertFieldExist(date, "serialVersionUID");
    SdkAssert.assertHasFlags(serialVersionUID1, 26);
    SdkAssert.assertFieldSignature(serialVersionUID1, "J");

    Assert.assertEquals("method count of 'Date'", 1, date.getMethods().size());
    ...
    Assert.assertEquals("inner types count of 'Date'", 0, date.getTypes().size());
    // type Double
    ...
    // fields of Double
    Assert.assertEquals("field count of 'Double'", 1, doubleT.getFields().size());
    IField serialVersionUID2 = SdkAssert.assertFieldExist(doubleT, "serialVersionUID");
    SdkAssert.assertHasFlags(serialVersionUID2, 26);
    SdkAssert.assertFieldSignature(serialVersionUID2, "J");

    Assert.assertEquals("method count of 'Double'", 1, doubleT.getMethods().size());
    ...
    Assert.assertEquals("inner types count of 'Double'", 0, doubleT.getTypes().size());
    ...
    Assert.assertEquals("field count of 'MultiTypeArgsBox'", 1, multiTypeArgsBox.getFields().size());
    ...
    Assert.assertEquals("method count of 'MultiTypeArgsBox'", 1, multiTypeArgsBox.getMethods().size());
    ...
    Assert.assertEquals("inner types count of 'MultiTypeArgsBox'", 0, multiTypeArgsBox.getTypes().size());
    // type SampleComposer
    ...
    Assert.assertEquals("field count of 'SampleComposer'", 1, sampleComposer.getFields().size());
    ...
    Assert.assertEquals("method count of 'SampleComposer'", 1, sampleComposer.getMethods().size());
    ...
    Assert.assertEquals("inner types count of 'SampleComposer'", 0, sampleComposer.getTypes().size());
    // type SampleDate
    ...
    Assert.assertEquals("field count of 'SampleDate'", 1, sampleDate.getFields().size());
    ...
    Assert.assertEquals("method count of 'SampleDate'", 1, sampleDate.getMethods().size());
    ...
    Assert.assertEquals("inner types count of 'SampleDate'", 0, sampleDate.getTypes().size());
    // type SampleSmart
    ...
    Assert.assertEquals("field count of 'SampleSmart'", 1, sampleSmart.getFields().size());
    ...
    Assert.assertEquals("method count of 'SampleSmart'", 1, sampleSmart.getMethods().size());
    ...
    Assert.assertEquals("inner types count of 'SampleSmart'", 0, sampleSmart.getTypes().size());
    // type SampleString
    ...
    Assert.assertEquals("field count of 'SampleString'", 1, sampleString.getFields().size());
    ...
    Assert.assertEquals("method count of 'SampleString'", 1, sampleString.getMethods().size());
    ...
    Assert.assertEquals("inner types count of 'SampleString'", 0, sampleString.getTypes().size());
    ...
    Assert.assertEquals("field count of 'SimpleNrProperty'", 1, simpleNrProperty.getFields().size());
    ...
    Assert.assertEquals("method count of 'SimpleNrProperty'", 1, simpleNrProperty.getMethods().size());
    ...
    Assert.assertEquals("inner types count of 'SimpleNrProperty'", 0, simpleNrProperty.getTypes().size());
  }
}
