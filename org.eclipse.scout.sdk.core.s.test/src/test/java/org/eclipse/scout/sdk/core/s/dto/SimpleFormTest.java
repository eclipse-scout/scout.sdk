...
public class SimpleFormTest {
  ...
  private static void testApiOfSimpleFormData(IType simpleFormData) {
    ...
    var getDouble = assertMethodExist(simpleFormData, "getDouble");
    ...
    var getMultiTypeArgsBox = assertMethodExist(simpleFormData, "getMultiTypeArgsBox");
    ...
    var getSampleComposer = assertMethodExist(simpleFormData, "getSampleComposer");
    ...
    var getSampleDate = assertMethodExist(simpleFormData, "getSampleDate");
    ...
    var getSampleSmart = assertMethodExist(simpleFormData, "getSampleSmart");
    ...
    var getSampleString = assertMethodExist(simpleFormData, "getSampleString");
  ...
  private static void assertValidDtoClassIdValue(IAnnotation classId) {
    assertTrue(classId.element("value").orElseThrow().value().as(String.class).endsWith("-formdata"));
  }
}
