...
public class FormWithGroupboxesTest {
  ...
  private static void testApiOfFormWithGroupBoxesFormData(IType formWithGroupBoxesFormData) {
    ...
    IField serialVersionUID = assertFieldExist(formWithGroupBoxesFormData, "serialVersionUID");
    assertHasFlags(serialVersionUID, 26);
    assertFieldType(serialVersionUID, "long");

    assertEquals(2, formWithGroupBoxesFormData.methods().stream().count(), "method count of 'FormWithGroupBoxesFormData'");
    IMethod getFlatString = assertMethodExist(formWithGroupBoxesFormData, "getFlatString", new String[]{});
    assertMethodReturnType(getFlatString, "formdata.shared.services.process.FormWithGroupBoxesFormData$FlatString");
    IMethod getInnerInteger = assertMethodExist(formWithGroupBoxesFormData, "getInnerInteger", new String[]{});
    ...
    // type FlatString
    IType flatString = assertTypeExists(formWithGroupBoxesFormData, "FlatString");
    ...
    IField serialVersionUID1 = assertFieldExist(flatString, "serialVersionUID");
    ...
    // type InnerInteger
    IType innerInteger = assertTypeExists(formWithGroupBoxesFormData, "InnerInteger");
    ...
    IField serialVersionUID2 = assertFieldExist(innerInteger, "serialVersionUID");
