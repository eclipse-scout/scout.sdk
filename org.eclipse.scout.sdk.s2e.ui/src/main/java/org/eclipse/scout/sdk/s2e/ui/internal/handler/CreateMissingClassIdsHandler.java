...
import org.eclipse.scout.sdk.s2e.classid.ClassIdNewOperation;
 ...
 * @since 5.2.0
 */
public class CreateMissingClassIdsHandler extends AbstractHandler {
  @Override
  public Object execute(ExecutionEvent event) throws ExecutionException {
    ...
    if (answer == SWT.YES) {
      new ResourceBlockingOperationJob(new ClassIdNewOperation()).schedule();
    }
    return null;
  }
}
