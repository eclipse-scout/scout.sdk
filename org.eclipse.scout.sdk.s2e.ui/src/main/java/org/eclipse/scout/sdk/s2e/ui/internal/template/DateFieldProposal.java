...
/**
 * <h3>{@link DateFieldProposal}</h3>
 *
 * @author Matthias Villiger
 * @since 5.2.0
 */
public class DateFieldProposal extends FormFieldProposal {

  public DateFieldProposal(String name, int relevance, String imageId, ICompilationUnit cu, TypeProposalContext context) {
    super(name, relevance, imageId, cu, context);
  }

  @Override
  protected TypeDeclaration createFormFieldType(Type superType) {
    return getFactory().newDateField(getProposalContext().getDefaultName())
