...
/**
 * <h3>{@link LongFieldProposal}</h3>
 *
 * @author Matthias Villiger
 * @since 5.2.0
 */
public class LongFieldProposal extends FormFieldProposal {

  public LongFieldProposal(String name, int relevance, String imageId, ICompilationUnit cu, TypeProposalContext context) {
    super(name, relevance, imageId, cu, context);
  }

  @Override
  protected TypeDeclaration createFormFieldType(Type superType) {
    return getFactory().newLongField(getProposalContext().getDefaultName())
