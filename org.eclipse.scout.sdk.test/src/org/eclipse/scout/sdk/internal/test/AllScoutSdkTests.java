...
import org.eclipse.scout.sdk.test.operation.form.FormDataUpdateOperationTest;
...
@RunWith(Suite.class)
@SuiteClasses({AllBugsBeforeOpensourceTests.class, FormDataUpdateOperationTest.class, AllOperationTest.class, ScoutSdkUtilityTest.class, RegexTest.class, AllTypeTest.class})
