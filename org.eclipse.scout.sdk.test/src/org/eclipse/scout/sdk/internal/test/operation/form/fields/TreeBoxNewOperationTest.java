...
/**
 * <h3>{@link TreeBoxNewOperationTest}</h3>
 *
 * @author Andreas Hoegger
 * @since 3.8.0 14.03.2013
 */
public class TreeBoxNewOperationTest extends AbstractSdkTestWithSampleProject {
  ...
  public void testNewField() throws Exception {
    ...
    TreeBoxNewOperation fieldNewOp = new TreeBoxNewOperation("TestField01", mainBox);
    fieldNewOp.setSuperTypeSignature(Signature.createTypeSignature(IRuntimeClasses.AbstractTreeBox, true));
    ...
    SdkAssert.assertHasSuperType(field, RuntimeClasses.ITreeBox);
  ...
  public void testNewFieldWithNlsText() throws Exception {
    Assert.assertTrue(TypeUtility.exists(getSharedJavaProject()));
    IType mainBox = TypeUtility.getType("sample.client.empty.EmptyForm.MainBox");
    TreeBoxNewOperation fieldNewOp = new TreeBoxNewOperation("TestField02", mainBox);
    fieldNewOp.setSuperTypeSignature(Signature.createTypeSignature(IRuntimeClasses.AbstractTreeBox, true));
    IType okButton = TypeUtility.getType("sample.client.empty.EmptyForm.MainBox.OkButton");
    fieldNewOp.setSibling(okButton);
    // nls
  ...
  public void testNewFieldCustomParent() throws Exception {
    Assert.assertTrue(TypeUtility.exists(getSharedJavaProject()));
    IType mainBox = TypeUtility.getType("sample.client.empty.EmptyForm.MainBox");
    TreeBoxNewOperation fieldNewOp = new TreeBoxNewOperation("TestField03", mainBox);
    fieldNewOp.setSuperTypeSignature(Signature.createTypeSignature("sample.client.field.ext.AbstractCustomTreeBox", true));
    IType okButton = TypeUtility.getType("sample.client.empty.EmptyForm.MainBox.OkButton");
    fieldNewOp.setSibling(okButton);
    executeBuildAssertNoCompileErrors(fieldNewOp);
    IType field = fieldNewOp.getCreatedField();
