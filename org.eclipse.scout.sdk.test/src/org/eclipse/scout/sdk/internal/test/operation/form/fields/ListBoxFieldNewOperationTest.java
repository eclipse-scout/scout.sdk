...
public class ListBoxFieldNewOperationTest extends AbstractFieldNewOperationTest {

  private ListBoxFieldNewOperation m_operation;
  ...
  public String getReferenceFilePath() {
    return "operation/form/fields/fieldReferences/Test1CreateListBoxField.java";
  }

  @Override
  public IOperation getOperation(IType declaringType, IStructuredType structuredType) {
    m_operation = new ListBoxFieldNewOperation(declaringType);
    m_operation.setFormatSource(true);
    m_operation.setTypeName("TestListboxField");
    m_operation.setSuperTypeSignature(Signature.createTypeSignature("org.eclipse.scout.rt.client.ui.form.fields.listbox.AbstractListBox<java.lang.Long>", true));
