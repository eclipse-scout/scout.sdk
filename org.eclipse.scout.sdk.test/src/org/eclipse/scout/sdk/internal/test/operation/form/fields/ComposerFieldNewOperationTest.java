...
/**
 * <h3>{@link ComposerFieldNewOperationTest}</h3> ...
 *
 * @author Andreas Hoegger
 * @since 3.8.0 14.03.2013
 */
public class ComposerFieldNewOperationTest extends AbstractSdkTestWithSampleProject {
  ...
  public void testNewField() throws Exception {
    ...
    ComposerFieldNewOperation fieldNewOp = new ComposerFieldNewOperation("TestField01", mainBox);
    fieldNewOp.setSuperTypeSignature(RuntimeClasses.getSuperTypeSignature(RuntimeClasses.IComposerField, mainBox.getJavaProject()));
