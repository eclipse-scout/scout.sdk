...
public class TypeHierarchyTest2 extends AbstractScoutSdkTest {
  ...
  public void testRemoveType() throws Exception {
    IScoutProject project = ScoutProjectHelper.setupNewProject("abc.testapp", true, true, true);
    ...
    createOutlineOp.setClientBundle(project.getClientBundle());
    ...
    // clean
    clearWorkspace();
    assertEquals(0, ScoutSdkCore.getScoutWorkspace().getRootProjects().length);
  }
  ...
  public void testRemoveProject() throws Exception {
    ...
    assertNull(project.getClientBundle());
    // clean
    clearWorkspace();
    assertEquals(0, ScoutSdkCore.getScoutWorkspace().getRootProjects().length);
  }
  ...
  public void testHierarchyExistenceOverTwoProjects() throws Exception {
    ...
    createOutlineOp2.setClientBundle(project2.getClientBundle());
