...
public class SequenceBoxNewOperationTest extends AbstractSdkTestWithSampleProject {
  ...
  @Test
  public void testDoubleSequenceBox() throws Exception {
    IType mainBox = TypeUtility.getType("sample.client.empty.EmptyForm.MainBox");
  ...
  public void testLongSequenceBox() throws Exception {
    IType mainBox = TypeUtility.getType("sample.client.empty.EmptyForm.MainBox");
    SequenceBoxNewOperation fieldNewOp = new SequenceBoxNewOperation("Test06Box", mainBox, true);
    ...
    SdkAssert.assertOrderAnnotation(field, Double.valueOf(-1000));
    SdkAssert.assertOrderAnnotation(okButton, Double.valueOf(10));
    IType from = SdkAssert.assertTypeExists(field, "Test06From");
