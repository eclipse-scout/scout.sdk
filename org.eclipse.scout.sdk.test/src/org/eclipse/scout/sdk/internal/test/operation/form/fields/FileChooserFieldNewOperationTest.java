...
/**
 * <h3>{@link FileChooserFieldNewOperationTest}</h3>
 *
 * @author Andreas Hoegger
 * @since 3.8.0 14.03.2013
 */
public class FileChooserFieldNewOperationTest extends AbstractSdkTestWithSampleProject {
  ...
  public void testNewField() throws Exception {
    ...
    FileChooserFieldNewOperation fieldNewOp = new FileChooserFieldNewOperation("TestField01", mainBox);
    fieldNewOp.setSuperTypeSignature(RuntimeClasses.getSuperTypeSignature(RuntimeClasses.IFileChooserField, mainBox.getJavaProject()));
    ...
    SdkAssert.assertHasSuperType(field, RuntimeClasses.IFileChooserField);
    // clean up
