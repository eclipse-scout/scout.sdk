...
/**
 * <h3>{@link GroupBoxNewOperationTest}</h3>
 *
 * @author Andreas Hoegger
 * @since 3.8.0 14.03.2013
 */
public class GroupBoxNewOperationTest extends AbstractSdkTestWithSampleProject {
  ...
  public void testNewField() throws Exception {
    ...
    GroupBoxNewOperation fieldNewOp = new GroupBoxNewOperation("TestField01", mainBox);
    fieldNewOp.setSuperTypeSignature(RuntimeClasses.getSuperTypeSignature(RuntimeClasses.IGroupBox, mainBox.getJavaProject()));
    ...
    SdkAssert.assertHasSuperType(field, RuntimeClasses.IGroupBox);
    // clean up
