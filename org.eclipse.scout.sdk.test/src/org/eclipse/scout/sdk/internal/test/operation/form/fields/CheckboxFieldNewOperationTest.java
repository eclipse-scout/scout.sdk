...
/**
 * <h3>{@link CheckboxFieldNewOperationTest}</h3>
 *
 * @author Andreas Hoegger
 * @since 3.8.0 14.03.2013
 */
public class CheckboxFieldNewOperationTest extends AbstractSdkTestWithSampleProject {
  ...
  public void testNewField() throws Exception {
    ...
    CheckboxFieldNewOperation fieldNewOp = new CheckboxFieldNewOperation("TestField01", mainBox);
    fieldNewOp.setSuperTypeSignature(RuntimeClasses.getSuperTypeSignature(RuntimeClasses.ICheckBox, mainBox.getJavaProject()));
