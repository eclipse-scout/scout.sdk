...
public class DoubleFieldNewOperationTest extends AbstractSdkTestWithSampleProject {
  ...
  public void testNewField() throws Exception {
    ...
    DoubleFieldNewOperation fieldNewOp = new DoubleFieldNewOperation("TestField01", mainBox);
    fieldNewOp.setSuperTypeSignature(RuntimeClasses.getSuperTypeSignature(RuntimeClasses.IDoubleField, mainBox.getJavaProject()));
