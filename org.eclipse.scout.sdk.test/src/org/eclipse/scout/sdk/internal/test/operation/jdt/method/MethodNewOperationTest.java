...
public class MethodNewOperationTest extends AbstractSdkTestWithJdtTestProject {
  ...
  public void testSimpleMethod() throws Exception {
    ...
    executeBuildAssertNoCompileErrors(SYSTEM_PROPERTIES_FORM_DATA_USER, methodOp);
  ...
  public void testOverrideNlsTextMehtod() throws Exception {
    ...
    executeBuildAssertNoCompileErrors(SYSTEM_PROPERTIES_FORM_DATA_USER, methodOverrideOp);
  ...
  public void testOverrideAnInterfaceMethod() throws Exception {
    ...
    TestWorkspaceUtility.executeAndBuildWorkspace(SYSTEM_PROPERTIES_FORM_DATA_USER, typeOp);
    ...
    executeBuildAssertNoCompileErrors(SYSTEM_PROPERTIES_FORM_DATA_USER, doStuffOverrideOp);
  ...
  public void testOverrideAnAbstractGenericMethod() throws Exception {
    ...
    executeBuildAssertNoCompileErrors(SYSTEM_PROPERTIES_FORM_DATA_USER, getValueOp);
    ...
    executeBuildAssertNoCompileErrors(SYSTEM_PROPERTIES_FORM_DATA_USER, setValueOp);
