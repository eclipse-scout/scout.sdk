...
public class StringFieldNewOperationTest extends AbstractSdkTestWithSampleProject {
  ...
  public void testNewField() throws Exception {
    ...
    StringFieldNewOperation booleanFieldNewOp = new StringFieldNewOperation("TestField01", mainBox);
    booleanFieldNewOp.setSuperTypeSignature(Signature.createTypeSignature("org.eclipse.scout.rt.client.ui.form.fields.stringfield.AbstractStringField", true));
  ...
  public void testNewFieldWithNlsText() throws Exception {
    Assert.assertTrue(TypeUtility.exists(getSharedJavaProject()));
    IType mainBox = TypeUtility.getType("sample.client.empty.EmptyForm.MainBox");
    StringFieldNewOperation booleanFieldNewOp = new StringFieldNewOperation("TestField02", mainBox);
    booleanFieldNewOp.setSuperTypeSignature(Signature.createTypeSignature("org.eclipse.scout.rt.client.ui.form.fields.stringfield.AbstractStringField", true));
    IType okButton = TypeUtility.getType("sample.client.empty.EmptyForm.MainBox.OkButton");
    booleanFieldNewOp.setSibling(okButton);
    // nls
