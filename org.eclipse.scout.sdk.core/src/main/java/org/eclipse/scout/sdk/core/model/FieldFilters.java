...
public final class FieldFilters {
   ...
   */
  public static IFilter<IField> getNameFilter(final String name) {
   ...
   * @see Flags
   */
  public static IFilter<IField> getFlagsFilter(final int flags) {
    return new IFilter<IField>() {
      @Override
      public boolean evaluate(IField field) {
   ...
   * @see Pattern
   */
  public static IFilter<IField> getNameRegexFilter(final Pattern regex) {
    return new IFilter<IField>() {
      @Override
      public boolean evaluate(IField field) {
