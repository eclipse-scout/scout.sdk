...
It exists in the `org.eclipse.scout.sdk.core.java.ecj` module and uses the https://wiki.eclipse.org/JDT_Core_Programmer_Guide/ECJ[Eclipse Compiler for Java] as parser.
