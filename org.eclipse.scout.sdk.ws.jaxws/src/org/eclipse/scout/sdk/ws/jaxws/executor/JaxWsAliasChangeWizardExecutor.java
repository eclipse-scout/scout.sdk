...
/**
 * <h3>{@link JaxWsAliasChangeWizardExecutor}</h3>
 *
 * @author Matthias Villiger
 * @since 4.1.0 14.10.2014
 */
public class JaxWsAliasChangeWizardExecutor extends AbstractExecutor {
  ...
  public Object run(Shell shell, IStructuredSelection selection, ExecutionEvent event) {
    IWizard wizard = new JaxWsServletRegistrationWizard(UiUtility.getScoutBundleFromSelection(selection));
