...
/**
 * <h3>{@link WsConsumerDeleteExecutor}</h3>
 *
 * @author Matthias Villiger
 * @since 4.1.0 14.10.2014
 */
public class WsConsumerDeleteExecutor extends AbstractExecutor {
  ...
  public Object run(Shell shell, IStructuredSelection selection, ExecutionEvent event) {
    ...
    if (sel instanceof WebServiceConsumerNodePage) {
      WebServiceConsumerNodePage page = (WebServiceConsumerNodePage) sel;

      WsConsumerDeleteWizard wizard = new WsConsumerDeleteWizard();
      wizard.setBundle(page.getScoutBundle());
      wizard.setType(page.getType());
      wizard.setBuildJaxWsBean(page.getBuildJaxWsBean());
