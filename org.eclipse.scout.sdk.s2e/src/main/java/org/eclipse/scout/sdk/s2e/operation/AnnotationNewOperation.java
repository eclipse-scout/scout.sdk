...
public class AnnotationNewOperation implements IOperation {
  ...
  public String getOperationName() {
    return "create annotation " + Signature.getSignatureSimpleName(m_sourceBuilder.getSignature()) + "...";
  }
  ...
  public void run(IProgressMonitor monitor, IWorkingCopyManager workingCopyManager) throws CoreException {
    ...
    ILookupEnvironment env = ScoutSdkCore.createLookupEnvironment(m_declaringMember.getJavaProject(), true);
    ImportValidator validator = new ImportValidator(pck, env);
  ...
  protected ISourceRange getAnnotationReplaceRange(Document sourceDocument, String newLine, String newAnnotationSource) throws JavaModelException, BadLocationException {
    String sn = Signature.getSignatureSimpleName(m_sourceBuilder.getSignature());
    String fqn = Signature.getSignatureQualifier(m_sourceBuilder.getSignature()) + "." + sn;
