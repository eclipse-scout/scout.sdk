...
public final class StructuredTypeFactory {
  ...
  private static IStructuredType createUnknownStructuredType(IType type) {
    EnumSet<Categories> enabled = EnumSet.of(Categories.FIELD_LOGGER, Categories.FIELD_STATIC, Categories.FIELD_MEMBER, Categories.FIELD_UNKNOWN, Categories.METHOD_CONSTRUCTOR, Categories.METHOD_CONFIG_PROPERTY, Categories.METHOD_CONFIG_EXEC, Categories.METHOD_FORM_DATA_BEAN, Categories.METHOD_OVERRIDDEN, Categories.METHOD_START_HANDLER, Categories.METHOD_INNER_TYPE_GETTER, Categories.METHOD_LOCAL_BEAN, Categories.METHOD_UNCATEGORIZED, Categories.TYPE_FORM_FIELD, Categories.TYPE_COLUMN, Categories.TYPE_CODE, Categories.TYPE_FORM, Categories.TYPE_TABLE, Categories.TYPE_ACTIVITY_MAP, Categories.TYPE_TREE, Categories.TYPE_CALENDAR, Categories.TYPE_CALENDAR_ITEM_PROVIDER, Categories.TYPE_WIZARD, Categories.TYPE_WIZARD_STEP, Categories.TYPE_MENU, Categories.TYPE_VIEW_BUTTON, Categories.TYPE_TOOL_BUTTON, Categories.TYPE_KEYSTROKE, Categories.TYPE_COMPOSER_ATTRIBUTE, Categories.TYPE_COMPOSER_ENTRY, Categories.TYPE_FORM_HANDLER, Categories.TYPE_UNCATEGORIZED);
    return new ScoutStructuredType(type, enabled);
  }

  public static IStructuredType createStructuredButton(IType type) {
    EnumSet<Categories> enabled = EnumSet.of(Categories.FIELD_STATIC, Categories.FIELD_MEMBER, Categories.FIELD_UNKNOWN, Categories.METHOD_CONSTRUCTOR, Categories.METHOD_CONFIG_PROPERTY, Categories.METHOD_CONFIG_EXEC, Categories.METHOD_OVERRIDDEN, Categories.METHOD_LOCAL_BEAN, Categories.METHOD_UNCATEGORIZED, Categories.TYPE_UNCATEGORIZED);
    return new ScoutStructuredType(type, enabled);
  }
  ...
  public static IStructuredType createStructuredToolButton(IType type) {
    EnumSet<Categories> enabled = EnumSet.of(Categories.FIELD_STATIC, Categories.FIELD_MEMBER, Categories.FIELD_UNKNOWN, Categories.METHOD_CONSTRUCTOR, Categories.METHOD_CONFIG_PROPERTY, Categories.METHOD_CONFIG_EXEC, Categories.METHOD_OVERRIDDEN, Categories.METHOD_LOCAL_BEAN, Categories.METHOD_UNCATEGORIZED, Categories.TYPE_TOOL_BUTTON, Categories.TYPE_UNCATEGORIZED);
    return new ScoutStructuredType(type, enabled);
  }
  ...
  public static IStructuredType createStructuredActivityMap(IType type) {
    EnumSet<Categories> enabled = EnumSet.of(Categories.FIELD_STATIC, Categories.FIELD_MEMBER, Categories.FIELD_UNKNOWN, Categories.METHOD_CONSTRUCTOR, Categories.METHOD_CONFIG_PROPERTY, Categories.METHOD_CONFIG_EXEC, Categories.METHOD_OVERRIDDEN, Categories.METHOD_LOCAL_BEAN, Categories.METHOD_UNCATEGORIZED, Categories.TYPE_MENU, Categories.TYPE_UNCATEGORIZED);
    return new ScoutStructuredType(type, enabled);
  }
  ...
  public static IStructuredType createStructuredFormHandler(IType type) {
    EnumSet<Categories> enabled = EnumSet.of(Categories.FIELD_MEMBER, Categories.FIELD_STATIC, Categories.FIELD_UNKNOWN, Categories.METHOD_CONSTRUCTOR, Categories.METHOD_CONFIG_PROPERTY, Categories.METHOD_CONFIG_EXEC, Categories.METHOD_OVERRIDDEN, Categories.METHOD_LOCAL_BEAN, Categories.METHOD_UNCATEGORIZED, Categories.TYPE_UNCATEGORIZED);
    return new ScoutStructuredType(type, enabled);
  }
  ...
  public static IStructuredType createStructuredForm(IType type, ITypeHierarchy localHierarchy) {
    EnumSet<Categories> enabled = EnumSet.of(Categories.FIELD_LOGGER, Categories.FIELD_STATIC, Categories.FIELD_MEMBER, Categories.FIELD_UNKNOWN, Categories.METHOD_CONSTRUCTOR, Categories.METHOD_CONFIG_PROPERTY, Categories.METHOD_CONFIG_EXEC, Categories.METHOD_FORM_DATA_BEAN, Categories.METHOD_OVERRIDDEN, Categories.METHOD_START_HANDLER, Categories.METHOD_INNER_TYPE_GETTER, Categories.METHOD_LOCAL_BEAN, Categories.METHOD_UNCATEGORIZED, Categories.TYPE_FORM_FIELD, Categories.TYPE_KEYSTROKE, Categories.TYPE_FORM_HANDLER, Categories.TYPE_UNCATEGORIZED);
  ...
  public static IStructuredType createStructuredComposer(IType type) {
    EnumSet<Categories> enabled = EnumSet.of(Categories.FIELD_LOGGER, Categories.FIELD_STATIC, Categories.FIELD_MEMBER, Categories.FIELD_UNKNOWN, Categories.METHOD_CONSTRUCTOR, Categories.METHOD_CONFIG_PROPERTY, Categories.METHOD_CONFIG_EXEC, Categories.METHOD_FORM_DATA_BEAN, Categories.METHOD_OVERRIDDEN, Categories.METHOD_LOCAL_BEAN, Categories.METHOD_UNCATEGORIZED, Categories.TYPE_COMPOSER_ATTRIBUTE, Categories.TYPE_COMPOSER_ENTRY, Categories.TYPE_UNCATEGORIZED);
    return new ScoutStructuredType(type, enabled);
  }
  ...
  public static IStructuredType createStructuredPageWithTable(IType type) {
    EnumSet<Categories> enabled = EnumSet.of(Categories.FIELD_LOGGER, Categories.FIELD_STATIC, Categories.FIELD_MEMBER, Categories.FIELD_UNKNOWN, Categories.METHOD_CONSTRUCTOR, Categories.METHOD_CONFIG_PROPERTY, Categories.METHOD_CONFIG_EXEC, Categories.METHOD_OVERRIDDEN, Categories.METHOD_LOCAL_BEAN, Categories.METHOD_UNCATEGORIZED, Categories.TYPE_TABLE, Categories.TYPE_UNCATEGORIZED);
    return new ScoutStructuredType(type, enabled);
  }
  ...
  public static IStructuredType createStructuredCalendar(IType type) {
    EnumSet<Categories> enabled = EnumSet.of(Categories.FIELD_LOGGER, Categories.FIELD_STATIC, Categories.FIELD_MEMBER, Categories.FIELD_UNKNOWN, Categories.METHOD_CONSTRUCTOR, Categories.METHOD_CONFIG_PROPERTY, Categories.METHOD_CONFIG_EXEC, Categories.METHOD_OVERRIDDEN, Categories.METHOD_INNER_TYPE_GETTER, Categories.METHOD_LOCAL_BEAN, Categories.METHOD_UNCATEGORIZED, Categories.TYPE_CALENDAR_ITEM_PROVIDER, Categories.TYPE_UNCATEGORIZED);
    return new ScoutStructuredType(type, enabled);
  }
}
