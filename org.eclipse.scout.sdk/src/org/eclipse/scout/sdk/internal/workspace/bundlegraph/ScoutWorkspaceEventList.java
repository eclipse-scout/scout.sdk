...
public class ScoutWorkspaceEventList {
  ...
  private HashSet<IScoutElement> m_eventElements = new HashSet<IScoutElement>();
  ...
  public void setEvent(int eventType, IScoutElement scoutElement, boolean overrideExisting) {
  ...
  public boolean containsEventFor(IScoutElement member) {
    synchronized (lock) {
      return m_eventElements.contains(member);
    }
  }

  public void addEvent(int eventType, IScoutElement scoutElement) {
    synchronized (lock) {
