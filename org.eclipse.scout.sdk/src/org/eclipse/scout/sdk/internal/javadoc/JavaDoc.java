 ...
 ******************************************************************************/
package org.eclipse.scout.sdk.internal.javadoc;
...
public class JavaDoc {
  ...
  public TextEdit getEdit() {
    String NL = ScoutUtility.getLineSeparator(getMember().getCompilationUnit());
    ...
    if (newLines.length > 0) {
      ...
      try {
        ...
        ScoutSdk.logWarning("could not parse java doc of '" + getMember().getElementName() + "' in compilation unit '" + getMember().getCompilationUnit().getElementName() + "'.", e);
      }
    }
    return null;
