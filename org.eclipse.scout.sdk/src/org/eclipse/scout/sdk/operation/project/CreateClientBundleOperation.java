...
public class CreateClientBundleOperation extends AbstractCreateScoutBundleOperation {
  ...
  public void run(IProgressMonitor monitor, IScoutWorkingCopyManager workingCopyManager) throws CoreException {
    ...
    new InstallBinaryFileOperation("templates/client/resources/icons/eye.png", "resources/icons/eye.png", project).run(monitor, workingCopyManager);
    new InstallBinaryFileOperation("templates/client/resources/icons/eclipse_scout.gif", "resources/icons/eclipse_scout.gif", project).run(monitor, workingCopyManager);
  }
