 ...
 */
public class FileChooserFieldNewOperation implements IOperation {
  ...
  public FileChooserFieldNewOperation(String typeName, IType declaringType) {
    this(typeName, declaringType, true);
  }

  public FileChooserFieldNewOperation(String typeName, IType declaringType, boolean formatSource) {
    m_typeName = typeName;
    m_declaringType = declaringType;
    m_formatSource = formatSource;
    // default
    setSuperTypeSignature(RuntimeClasses.getSuperTypeSignature(IRuntimeClasses.IFileChooserField, getDeclaringType().getJavaProject()));
  }
