...
public class TreeBoxNewOperation implements IOperation {
  ...
  public TreeBoxNewOperation(String typeName, IType declaringType, boolean formatSource) {
    m_typeName = typeName;
    m_declaringType = declaringType;
    m_formatSource = formatSource;
    // default
    setSuperTypeSignature(RuntimeClasses.getSuperTypeSignature(IRuntimeClasses.ITreeBox, getDeclaringType().getJavaProject()));
  }
