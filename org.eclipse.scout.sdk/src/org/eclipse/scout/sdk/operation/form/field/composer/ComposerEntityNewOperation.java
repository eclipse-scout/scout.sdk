 ...
 */
public class ComposerEntityNewOperation extends OrderedInnerTypeNewOperation {
  ...
  public ComposerEntityNewOperation(String entityName, IType declaringType, boolean formatSource) {
    ...
    setOrderDefinitionType(TypeUtility.getType(IRuntimeClasses.IDataModelEntity));
  }
