...
/**
 * <h3>CheckboxFieldNewOperation</h3> ...
 */
public class CheckboxFieldNewOperation implements IOperation {
  ...
  public CheckboxFieldNewOperation(String typeName, IType declaringType) {
    this(typeName, declaringType, true);
  }

  public CheckboxFieldNewOperation(String typeName, IType declaringType, boolean fomatSource) {
    m_typeName = typeName;
    m_declaringType = declaringType;
    m_formatSource = fomatSource;
    // default
    setSuperTypeSignature(RuntimeClasses.getSuperTypeSignature(IRuntimeClasses.ICheckBox, getDeclaringType().getJavaProject()));
  }

  @Override
  public String getOperationName() {
    return "Create Checkbox field '" + getTypeName() + "'...";
  }
