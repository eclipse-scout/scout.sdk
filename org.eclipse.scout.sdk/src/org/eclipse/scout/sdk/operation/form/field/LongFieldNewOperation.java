 ...
 */
public class LongFieldNewOperation implements IOperation {
  ...
  public LongFieldNewOperation(String typeName, IType declaringType) {
    this(typeName, declaringType, true);
  }

  public LongFieldNewOperation(String typeName, IType declaringType, boolean formatSource) {
    m_typeName = typeName;
    m_declaringType = declaringType;
    m_formatSource = formatSource;
    // default
    setSuperTypeSignature(RuntimeClasses.getSuperTypeSignature(IRuntimeClasses.ILongField, getDeclaringType().getJavaProject()));
  }
