...
/**
 * <h3>ImageFieldNewOperation</h3> ...
 */
public class ImageFieldNewOperation implements IOperation {
  ...
  public ImageFieldNewOperation(String typeName, IType declaringType) {
    this(typeName, declaringType, true);

  }

  public ImageFieldNewOperation(String typeName, IType declaringType, boolean formatSource) {
    m_typeName = typeName;
    m_declaringType = declaringType;
    m_formatSource = formatSource;
    // default
    setSuperTypeSignature(RuntimeClasses.getSuperTypeSignature(IRuntimeClasses.IImageField, getDeclaringType().getJavaProject()));
  }
