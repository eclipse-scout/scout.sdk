...
////    createInnerTypeOp.setFlags(Flags.AccPublic);
////    createInnerTypeOp.setSibling(getSiblingField());
////    createInnerTypeOp.setSuperTypeSignature(getSuperTypeSignature());
////    createInnerTypeOp.addAnnotationSourceBuilder(AnnotationSourceBuilderFactory.createOrderAnnotation(getOrderNr()));
...
//    createInnerTypeOp.setSibling(getSiblingField());
//    createInnerTypeOp.setSuperTypeSignature(getSuperTypeSignature());
//    createInnerTypeOp.addAnnotation(new OrderAnnotationCreateOperation(null, getOrderNr()));
//    createInnerTypeOp.validate();
//    createInnerTypeOp.run(monitor, manager);
//    m_createdFormField = createInnerTypeOp.getCreatedType();
//    if (isCreateFormFieldGetterMethod()) {
...
//  }
//}
//>>>>>>> branch 'master' of ssh://ahoegger@git.eclipse.org/gitroot/scout/org.eclipse.scout.sdk.git
