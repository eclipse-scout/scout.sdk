...
public class BooleanFieldNewOperation implements IOperation {
  ...
  public BooleanFieldNewOperation(String typeName, IType declaringType) {
    this(typeName, declaringType, true);
  }

  public BooleanFieldNewOperation(String typeName, IType declaringType, boolean fomatSource) {
    m_typeName = typeName;
    m_declaringType = declaringType;
    m_formatSource = fomatSource;
    // default
    setSuperTypeSignature(RuntimeClasses.getSuperTypeSignature(IRuntimeClasses.IBooleanField, getDeclaringType().getJavaProject()));
  }
