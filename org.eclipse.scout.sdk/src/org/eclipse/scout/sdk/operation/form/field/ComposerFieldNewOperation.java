...
public class ComposerFieldNewOperation implements IOperation {
  ...
  public ComposerFieldNewOperation(String typeName, IType declaringType) {
    this(typeName, declaringType, true);
  }

  public ComposerFieldNewOperation(String typeName, IType declaringType, boolean formatSource) {
    m_typeName = typeName;
    m_declaringType = declaringType;
    m_formatSource = formatSource;
    // default
    setSuperTypeSignature(RuntimeClasses.getSuperTypeSignature(IRuntimeClasses.IComposerField, getDeclaringType().getJavaProject()));
  }
