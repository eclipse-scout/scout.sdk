...
public class DefaultFormFieldNewOperation implements IOperation {
  ...
  public DefaultFormFieldNewOperation(String typeName, IType declaringType) {
    this(typeName, declaringType, true);
  }

  public DefaultFormFieldNewOperation(String typeName, IType declaringType, boolean formatSource) {
    m_typeName = typeName;
