 ...
 */
public class DoubleFieldNewOperation implements IOperation {
  ...
  public DoubleFieldNewOperation(String typeName, IType declaringType) {
    this(typeName, declaringType, true);
  }

  public DoubleFieldNewOperation(String typeName, IType declaringType, boolean formatSource) {
    m_typeName = typeName;
    m_declaringType = declaringType;
    m_formatSource = formatSource;
    // default
    setSuperTypeSignature(RuntimeClasses.getSuperTypeSignature(IRuntimeClasses.IDoubleField, getDeclaringType().getJavaProject()));
  }
