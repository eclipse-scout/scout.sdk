 ...
 */
public class IntegerFieldNewOperation implements IOperation {
  ...
  public IntegerFieldNewOperation(String typeName, IType declaringType) {
    this(typeName, declaringType, true);
  }

  public IntegerFieldNewOperation(String typeName, IType declaringType, boolean formatSource) {
    m_typeName = typeName;
    m_declaringType = declaringType;
    m_formatSource = formatSource;
    // default
    setSuperTypeSignature(RuntimeClasses.getSuperTypeSignature(IRuntimeClasses.IIntegerField, getDeclaringType().getJavaProject()));
  }
