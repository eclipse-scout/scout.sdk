...
public class SequenceBoxNewOperation implements IOperation {
  ...
  public SequenceBoxNewOperation(IType declaringType) {
    this(declaringType, false);
  }

  public SequenceBoxNewOperation(IType declaringType, boolean formatSource) {
  ...
  public void run(IProgressMonitor monitor, IWorkingCopyManager workingCopyManager) throws CoreException, IllegalArgumentException {
    ...
    if (getContentTemplate() != null) {
      getContentTemplate().apply(getCreatedField(), workingCopyManager, monitor);
    }
    if (isFormatSource()) {
      // format
