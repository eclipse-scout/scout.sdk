...
/**
 * <h3>TabBoxNewOperation</h3>
 */
public class TabBoxNewOperation implements IOperation {
  ...
  public TabBoxNewOperation(String typeName, IType declaringType) {
    this(typeName, declaringType, true);
  }

  public TabBoxNewOperation(String typeName, IType declaringType, boolean formatSource) {
    m_typeName = typeName;
    m_declaringType = declaringType;
    m_formatSource = formatSource;
    // default
    setSuperTypeSignature(RuntimeClasses.getSuperTypeSignature(IRuntimeClasses.ITabBox, getDeclaringType().getJavaProject()));
  }
