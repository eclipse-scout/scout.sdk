 ...
 */
public class LabelFieldNewOperation implements IOperation {
  ...
  public LabelFieldNewOperation(String typeName, IType declaringType) {
    this(typeName, declaringType, true);
  }

  public LabelFieldNewOperation(String typeName, IType declaringType, boolean formatSource) {
    m_typeName = typeName;
    m_declaringType = declaringType;
    m_formatSource = formatSource;
    // default
    setSuperTypeSignature(RuntimeClasses.getSuperTypeSignature(IRuntimeClasses.ILabelField, getDeclaringType().getJavaProject()));
  }
