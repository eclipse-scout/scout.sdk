...
public class MessageBoxServiceFactory {
  ...
  public static IMessageBoxService getMessageBoxService() {
    ...
    try {
      serviceReference = bundleContext.getServiceReference(IMessageBoxService.class.getName());
      if (serviceReference != null) {
        Object service = bundleContext.getService(serviceReference);
        if (service instanceof IMessageBoxService) {
          return (IMessageBoxService) service;
        }
      }
    }
    catch (Throwable t) {
