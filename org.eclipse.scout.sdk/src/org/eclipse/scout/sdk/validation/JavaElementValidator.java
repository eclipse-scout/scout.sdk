...
public final class JavaElementValidator {
  ...
  public final static String[] JAVA_KEY_WORDS = new String[]{"abstract", "assert", "boolean", "break", "byte", "case", "catch", "char", "class", "const", "continue", "default", "do", "double", "else", "enum",
