...
import org.eclipse.scout.sdk.operation.util.AbstractScoutTypeNewOperation;
...
public class ClassIdGenerationContext {
  ...
  private AbstractScoutTypeNewOperation m_typeNewOp;
  private IType m_declaringType;

  public ClassIdGenerationContext(AbstractScoutTypeNewOperation parentSourceBuilder) {
    m_declaringTypeFqn = parentSourceBuilder.getFullyQualifiedName();
    m_typeNewOp = parentSourceBuilder;
  }
   ...
   */
  public AbstractScoutTypeNewOperation getParentTypeNewOperation() {
    return m_typeNewOp;
  }
