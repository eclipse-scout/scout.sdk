...
/**
 * <h3>{@link org_eclipse_scout_sdk_core_fixture_AnnotationWithSingleValues}</h3> managed wrapper for
 * {@link AnnotationWithSingleValues}
 *
 * @author imo
 * @since 5.1.0
 */
public class org_eclipse_scout_sdk_core_fixture_AnnotationWithSingleValues extends AbstractManagedAnnotation {
  public static final String TYPE_NAME = AnnotationWithSingleValues.class.getName();
