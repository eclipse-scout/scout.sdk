...
public interface IMethodGenerator<TYPE extends IMethodGenerator<TYPE, BODY>, BODY extends IMethodBodyBuilder<?>> extends IMemberGenerator<TYPE> {
   ...
   *          considered to be the declaring type of this {@link IMethodGenerator}. Therefore, only the super types of
   *          it are searched to check if an override annotation is necessary.
   * @return This generator.
   */
