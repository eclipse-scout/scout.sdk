...
public class SourceModelRoundtripTest {
  ...
  protected static void assertEqualsRefFile(String refFileName, IType type, IJavaEnvironment env) {
    SdkJavaAssertions.assertEqualsRefFile(env, REF_FILE_FOLDER + refFileName, type.requireCompilationUnit().toWorkingCopy());
  }
  ...
  private static void testApiOfClassWithMembers(IType classWithMembers) {
    ...
    assertEquals(15, classWithMembers.fields().stream().count(), "field count of 'org.eclipse.scout.sdk.core.java.fixture.ClassWithMembers'");
    ...
    assertEquals(4, classWithMembers.methods().stream().count(), "method count of 'org.eclipse.scout.sdk.core.java.fixture.ClassWithMembers'");
    ...
    assertAnnotation(m1, "org.eclipse.scout.sdk.core.java.fixture.TestAnnotation");
    ...
    assertAnnotation(m2, "org.eclipse.scout.sdk.core.java.fixture.TestAnnotation");
    ...
    assertAnnotation(m3, "org.eclipse.scout.sdk.core.java.fixture.TestAnnotation");
    ...
    assertEquals(0, innerStaticClass.fields().stream().count(), "field count of 'org.eclipse.scout.sdk.core.java.fixture.ClassWithMembers$InnerStaticClass'");

    assertEquals(1, innerStaticClass.methods().stream().count(), "method count of 'org.eclipse.scout.sdk.core.java.fixture.ClassWithMembers$InnerStaticClass'");
    ...
    assertEquals(0, innerMemberClass.fields().stream().count(), "field count of 'org.eclipse.scout.sdk.core.java.fixture.ClassWithMembers$InnerMemberClass'");

    assertEquals(1, innerMemberClass.methods().stream().count(), "method count of 'org.eclipse.scout.sdk.core.java.fixture.ClassWithMembers$InnerMemberClass'");
