...
public interface Scout262Api extends IScoutApi, IScout242Api, IScoutChartApi, IScout22DoApi, IChainedApiComputationAbortSupport, ISerialApi {
  @Override
  ...
  @Override
  default boolean isSerialAnnotationEnabled() {
    return true;
  }
}
