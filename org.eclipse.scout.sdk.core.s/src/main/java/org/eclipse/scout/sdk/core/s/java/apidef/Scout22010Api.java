...
public interface Scout22010Api extends IScoutApi {
  ...
  IScoutVariousApi.ChartUiTextContributor CHART_UI_TEXT_CONTRIBUTOR = new ChartUiTextContributor();

  @Override
  default IScoutVariousApi.ChartUiTextContributor ChartUiTextContributor() {
    return CHART_UI_TEXT_CONTRIBUTOR;
  }

  class ChartUiTextContributor implements IScoutVariousApi.ChartUiTextContributor {
    @Override
    public String fqn() {
  ...
  IScoutInterfaceApi.DoSet DO_SET = new DoSet();

  @Override
  default IScoutInterfaceApi.DoSet DoSet() {
    return DO_SET;
  }

  class DoSet implements IScoutInterfaceApi.DoSet {
    @Override
    public String fqn() {
  ...
  IScoutInterfaceApi.DoCollection DO_COLLECTION = new DoCollection();

  @Override
  default IScoutInterfaceApi.DoCollection DoCollection() {
    return DO_COLLECTION;
  }

  class DoCollection implements IScoutInterfaceApi.DoCollection {
    @Override
    public String fqn() {
  ...
  IScoutInterfaceApi.DoEntity DO_ENTITY = new Scout22010Api.DoEntity();
  ...
  IScoutInterfaceApi.ITypeVersion I_TYPE_VERSION = new Scout22010Api.ITypeVersion();

  @Override
  default IScoutInterfaceApi.ITypeVersion ITypeVersion() {
    return I_TYPE_VERSION;
  }

  class ITypeVersion implements IScoutInterfaceApi.ITypeVersion {
  ...
  IScoutInterfaceApi.INamespace I_NAMESPACE = new Scout22010Api.INamespace();

  @Override
  default IScoutInterfaceApi.INamespace INamespace() {
    return I_NAMESPACE;
  }

  class INamespace implements IScoutInterfaceApi.INamespace {
