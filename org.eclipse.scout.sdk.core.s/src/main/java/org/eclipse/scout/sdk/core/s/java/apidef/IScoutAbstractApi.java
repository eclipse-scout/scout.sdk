...
public interface IScoutAbstractApi {
  ...
  boolean createPermissionIdField();

  String getPermissionIdFieldDataTypeFqn();

  void appendPermissionIdFieldValue(IExpressionBuilder<?> builder, String permissionName);
}
