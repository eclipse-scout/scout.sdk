...
public class NlsEntryModifyAction extends AbstractWorkspaceAction {
  ...
  public NlsEntryModifyAction(NlsEntry entry, boolean interactWithUi, INlsProject project) {
    super("Modify Entry...", interactWithUi);
    m_entry = entry;
    if (m_entry == null) {
  ...
  protected boolean interactWithUi() {
    NlsEntryModifyDialog dialog = new NlsEntryModifyDialog(Display.getDefault().getActiveShell(), "New Entry", m_entry, m_project);
    m_entry = dialog.show();
    return m_entry != null;
  }
