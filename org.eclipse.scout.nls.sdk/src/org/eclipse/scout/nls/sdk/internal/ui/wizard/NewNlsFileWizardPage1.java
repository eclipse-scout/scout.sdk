...
public class NewNlsFileWizardPage1 extends NewTypeWizardPage {
  ...
  private Control createDynStatRadioBox(Composite parent) {
    ...
    // m_dynamicBinding = new Button(checkBoxGroup, SWT.RADIO);
    // m_dynamicBinding.setText("Dynamic");
    // m_dynamicBinding.addSelectionListener(new SelectionAdapter() {
    // @Override
    // public void widgetSelected(SelectionEvent e) {
    // m_desc.setFileTypeDynamic(true);
    // }
    // });
    // m_staticBinding = new Button(checkBoxGroup, SWT.RADIO);
    // m_staticBinding.setText("Static");
    // m_staticBinding.addSelectionListener(new SelectionAdapter() {
    // @Override
    // public void widgetSelected(SelectionEvent e) {
    // m_desc.setFileTypeDynamic(false);
    // }
    // });
  ...
  private void revalidate() {
    ...
    if (m_desc.isFileTypeDynamic()) {
      ...
      m_fieldValidator.setDisabled(m_nlsParentPluginField);
      m_fieldValidator.setDisabled(m_nlsParentFile);
    }
