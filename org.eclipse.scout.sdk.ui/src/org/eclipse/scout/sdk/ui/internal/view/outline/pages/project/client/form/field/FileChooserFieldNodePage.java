...
public class FileChooserFieldNodePage extends AbstractFormFieldNodePage {

  public FileChooserFieldNodePage() {
    setImageDescriptor(ScoutSdkUi.getImageDescriptor(ScoutSdkUi.FileChooserField));
  }

  @Override
  public String getPageId() {
    return IScoutPageConstants.FILE_CHOOSER_FIELD_NODE_PAGE;
  }
  ...
  public Action createDeleteAction() {
    ...
    if (deleteAction != null) {
      deleteAction.setImageDescriptor(ScoutSdkUi.getImageDescriptor(ScoutSdkUi.FileChooserFieldRemove));
    }
    return deleteAction;
  }
  ...
  public Action createEditAction() {
    // XXX
    return null;
    // return new EditAction(new EntityEditOrder(new FileChooserFieldEntity(getType())));
  }
}
