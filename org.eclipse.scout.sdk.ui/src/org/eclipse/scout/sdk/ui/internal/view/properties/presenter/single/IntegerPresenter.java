...
public class IntegerPresenter extends AbstractValuePresenter<Integer> {
  ...
  public IntegerPresenter(FormToolkit toolkit, Composite parent) {
  ...
  protected Integer parseDisplayInput(String input) throws CoreException {
    if (input.equals("")) {
      ...
      Integer d = PropertyMethodSourceUtilities.parseReturnParameterInteger(input, getMethod().peekMethod(), getMethod().getSuperTypeHierarchy());
      return d;
    }
  }
