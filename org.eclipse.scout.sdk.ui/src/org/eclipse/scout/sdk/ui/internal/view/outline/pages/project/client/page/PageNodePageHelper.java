...
public class PageNodePageHelper {
  ...
  public static AbstractPage[] createRepresentationFor(AbstractPage parentPage, IType[] types, ITypeHierarchy pageTypeHierarchy) {
    return instance.createRepresentationForImpl(parentPage, types, pageTypeHierarchy);
  }

  private AbstractPage[] createRepresentationForImpl(AbstractPage parentPage, IType[] types, ITypeHierarchy pageTypeHierarchy) {
