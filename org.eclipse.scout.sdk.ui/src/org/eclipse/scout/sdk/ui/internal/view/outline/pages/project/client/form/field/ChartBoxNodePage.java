...
public class ChartBoxNodePage extends AbstractFormFieldNodePage {

  public ChartBoxNodePage() {
  }

  @Override
  public String getPageId() {
    return IScoutPageConstants.CHART_BOX_NODE_PAGE;
  }
  ...
  public Action createEditAction() {
    // XXX
    return null;
    // return new EditAction(new EntityEditOrder(new ChartBoxEntity(getType())));
  }
