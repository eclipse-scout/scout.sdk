...
public class AxisWebServiceConsumerNodePage extends AbstractScoutTypePage {
  ...
  public String getPageId() {
    return IScoutPageConstants.AXIS_WEB_SERVICE_CONSUMER_NODE_PAGE;
  }
  ...
  public Action createDeleteAction() {
    return new AxisWebServiceConsumerDeleteAction(getOutlineView().getSite().getShell());
  }
}
