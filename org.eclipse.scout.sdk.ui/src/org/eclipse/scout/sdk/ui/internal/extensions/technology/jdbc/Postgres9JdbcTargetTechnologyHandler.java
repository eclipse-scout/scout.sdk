 ...
 */
public class Postgres9JdbcTargetTechnologyHandler extends AbstractScoutTechnologyHandler implements IMarketplaceConstants {
  ...
  public boolean preSelectionChanged(Set<IScoutTechnologyResource> resources, boolean selected, IProgressMonitor monitor) throws CoreException {
    ...
    return showLicenseDialog(selected, monitor, new String[]{SCOUT_POSTGRES_JDBC_FEATURE}, new String[]{SCOUT_JDBC_FEATURE_URL});
  }
  ...
  public void selectionChanged(Set<IScoutTechnologyResource> resources, boolean selected, IProgressMonitor monitor, IWorkingCopyManager workingCopyManager) throws CoreException {
    selectionChangedTargetFiles(resources, selected, monitor,
        new String[]{SCOUT_POSTGRES_JDBC_FEATURE}, new String[]{null},
  ...
  public TriState getSelection(IScoutBundle project) throws CoreException {
    ...
    return getSelectionTargetFileContainsFeature(targetFiles, SCOUT_POSTGRES_JDBC_FEATURE);
  }
