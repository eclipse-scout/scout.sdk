...
public class LabelFieldNodePage extends AbstractFormFieldNodePage {
  ...
  public Action createEditAction() {
    // XXX
    return null;
    // return new EditAction(new EntityEditOrder(new LabelFieldEntity(getType())));
  }
  ...
  public Action createDeleteAction() {
    ...
    if (deleteAction != null) {
      deleteAction.setImageDescriptor(ScoutSdkUi.getImageDescriptor(ScoutSdkUi.LabelFieldRemove));
    }
    return deleteAction;
  }
