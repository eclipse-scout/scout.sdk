...
public class PlannerFieldNodePage extends AbstractFormFieldNodePage {
  ...
  public PlannerFieldNodePage() {
    setImageDescriptor(ScoutSdkUi.getImageDescriptor(ScoutSdkUi.PlannerField));
  }
  ...
  public Action createDeleteAction() {
    ...
    if (deleteAction != null) {
      deleteAction.setImageDescriptor(ScoutSdkUi.getImageDescriptor(ScoutSdkUi.PlannerFieldRemove));
    }
    return deleteAction;
  }
}
