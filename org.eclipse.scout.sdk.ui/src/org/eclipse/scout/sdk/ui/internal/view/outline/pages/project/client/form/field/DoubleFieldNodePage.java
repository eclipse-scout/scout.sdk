...
public class DoubleFieldNodePage extends AbstractFormFieldNodePage {
  ...
  public DoubleFieldNodePage() {
    setImageDescriptor(ScoutSdkUi.getImageDescriptor(ScoutSdkUi.DoubleField));
  }
  ...
  public Action createDeleteAction() {
    ...
    if (deleteAction != null) {
      deleteAction.setImageDescriptor(ScoutSdkUi.getImageDescriptor(ScoutSdkUi.DoubleFieldRemove));
    }
    return deleteAction;
  }
