...
public class SqlServiceNodePage extends AbstractServiceNodePage {
  ...
  public Action createRenameAction() {
    return new ServiceRenameAction(getOutlineView().getSite().getShell(), "Rename...", getType(), getInterfaceType(), ScoutIdeProperties.SUFFIX_SQL_SERVICE);
  }

  @Override
  public Action createDeleteAction() {
    ServiceDeleteAction deleteAction = new ServiceDeleteAction(getOutlineView().getSite().getShell(), null, getType());
    deleteAction.setImageDescriptor(ScoutSdkUi.getImageDescriptor(ScoutSdkUi.SqlServiceRemove));
    return deleteAction;
  }
}
