...
public class DateFieldNodePage extends AbstractFormFieldNodePage {
  ...
  public Action createEditAction() {
    // XXX
    return null;
    // return new EditAction(new EntityEditOrder(new DateFieldEntity(getType())));
  }
  ...
  public Action createDeleteAction() {
    ...
    if (deleteAction != null) {
      deleteAction.setImageDescriptor(ScoutSdkUi.getImageDescriptor(ScoutSdkUi.DateFieldRemove));
    }
    return deleteAction;
  }
