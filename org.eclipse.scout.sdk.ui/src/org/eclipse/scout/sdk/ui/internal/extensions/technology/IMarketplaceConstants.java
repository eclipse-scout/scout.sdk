...
public interface IMarketplaceConstants {
  ...
  // db drivers
  String SCOUT_JDBC_FEATURE_URL = "http://tools.bsiag.com/marketplace/jdbc/4.2";
  ...
  String SCOUT_RAYO_FEATURE_URL = "http://tools.bsiag.com/marketplace/rayo/4.2";
  ...
  // docx4j support
  String SCOUT_DOCX4J_FEATURE_URL = "http://tools.bsiag.com/marketplace/docx4j/4.2";
  ...
  // logging bridge
  String SCOUT_LOGGING_BRIDGE_FEATURE_URL = "http://tools.bsiag.com/marketplace/logging_bridge/4.2";
  ...
  // f2
  String F2_FEATURE_URL = "http://tools.bsiag.com/marketplace/f2/4.2";
