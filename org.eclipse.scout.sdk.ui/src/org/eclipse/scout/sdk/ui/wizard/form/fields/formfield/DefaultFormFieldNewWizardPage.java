...
public class DefaultFormFieldNewWizardPage extends AbstractWorkspaceWizardPage {
  ...
  final IType abstractFormField = ScoutSdk.getType(RuntimeClasses.AbstractFormField);
  ...
  protected void createContent(Composite parent) {
    ...
    ITypeProposal[] shotList = ScoutProposalUtility.getScoutTypeProposalsFor(ScoutSdk.getType(RuntimeClasses.AbstractFormField));
