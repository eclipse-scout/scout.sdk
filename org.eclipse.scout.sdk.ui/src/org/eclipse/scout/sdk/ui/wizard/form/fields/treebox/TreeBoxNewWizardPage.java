...
public class TreeBoxNewWizardPage extends AbstractWorkspaceWizardPage {
  final IType iTreeBox = ScoutSdk.getType(RuntimeClasses.ITreeBox);
  final IType abstractTreeBox = ScoutSdk.getType(RuntimeClasses.AbstractTreeBox);
  ...
  public TreeBoxNewWizardPage(IType declaringType) {
    ...
    setTitle("New Tree Box");
    setDefaultMessage("Create a new tree box.");
