...
public class DoubleFieldNewWizardPage extends AbstractWorkspaceWizardPage {
  ...
  public DoubleFieldNewWizardPage(IType declaringType) {
    ...
    setSuperType(RuntimeClasses.getSuperType(RuntimeClasses.IDoubleField, m_declaringType.getJavaProject()));
  ...
  public boolean performFinish(IProgressMonitor monitor, IWorkingCopyManager workingCopyManager) throws CoreException {
    DoubleFieldNewOperation operation = new DoubleFieldNewOperation(getTypeName(), m_declaringType, true);
    // write back members
    if (getNlsName() != null) {
