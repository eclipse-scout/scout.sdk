...
public class ComposerFieldNewWizardPage extends AbstractWorkspaceWizardPage {
  ...
  public ComposerFieldNewWizardPage(IType declaringType) {
    ...
    setSuperType(RuntimeClasses.getSuperType(RuntimeClasses.IComposerField, m_declaringType.getJavaProject()));
  ...
  public boolean performFinish(IProgressMonitor monitor, IWorkingCopyManager workingCopyManager) throws CoreException {
    ComposerFieldNewOperation operation = new ComposerFieldNewOperation(getTypeName(), m_declaringType, true);
    // write back members
    if (getNlsName() != null) {
