...
public class CheckboxFieldNewWizardPage extends AbstractWorkspaceWizardPage {
  ...
  final IType iCheckBox = ScoutSdk.getType(RuntimeClasses.ICheckBox);
  final IType abstractCheckBox = ScoutSdk.getType(RuntimeClasses.AbstractCheckBox);
  ...
  public CheckboxFieldNewWizardPage(IType declaringType) {
    ...
    setTitle("New CheckboxField");
    setDefaultMessage("Create a new checkbox field.");
