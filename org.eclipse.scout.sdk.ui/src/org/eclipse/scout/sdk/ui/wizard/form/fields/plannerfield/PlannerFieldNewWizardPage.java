...
public class PlannerFieldNewWizardPage extends AbstractWorkspaceWizardPage {
  ...
  public PlannerFieldNewWizardPage(IType declaringType) {
    ...
    setSuperType(RuntimeClasses.getSuperType(IRuntimeClasses.IPlannerField, m_declaringType.getJavaProject()));
  ...
  public boolean performFinish(IProgressMonitor monitor, IWorkingCopyManager workingCopyManager) throws CoreException {
    PlannerFieldNewOperation operation = new PlannerFieldNewOperation(getTypeName(), m_declaringType, true);
    // write back members
    if (getNlsName() != null) {
