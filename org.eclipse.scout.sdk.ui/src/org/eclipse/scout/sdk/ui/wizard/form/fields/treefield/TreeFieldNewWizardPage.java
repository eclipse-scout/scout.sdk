 ...
 ******************************************************************************/
package org.eclipse.scout.sdk.ui.wizard.form.fields.treefield;
...
/**
 * <h3>TreeFieldNewWizardPage</h3> ...
 */
public class TreeFieldNewWizardPage extends AbstractWorkspaceWizardPage {
  ...
  public TreeFieldNewWizardPage(IType declaringType) {
    ...
    m_definitionType = TypeUtility.getType(RuntimeClasses.ITreeField);
    setSuperType(TypeUtility.getType(RuntimeClasses.AbstractTreeField));
