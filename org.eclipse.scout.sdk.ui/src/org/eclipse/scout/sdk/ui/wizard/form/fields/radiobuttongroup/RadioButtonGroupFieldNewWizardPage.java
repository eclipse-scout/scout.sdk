...
public class RadioButtonGroupFieldNewWizardPage extends AbstractWorkspaceWizardPage {
  ...
  final IType abstractRadioButtonGroup = ScoutSdk.getType(RuntimeClasses.AbstractRadioButtonGroup);
  ...
  protected IStatus getStatusNameField() throws JavaModelException {
    if (StringUtility.isNullOrEmpty(getTypeName()) || getTypeName().equals(ScoutIdeProperties.SUFFIX_BUTTON_GROUP)) {
