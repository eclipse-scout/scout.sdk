...
public class GroupBoxNewWizardPage extends AbstractWorkspaceWizardPage {
  ...
  public GroupBoxNewWizardPage(IType declaringType) {
    ...
    setSuperType(RuntimeClasses.getSuperType(RuntimeClasses.IGroupBox, m_declaringType.getJavaProject()));
  ...
  public boolean performFinish(IProgressMonitor monitor, IWorkingCopyManager workingCopyManager) throws CoreException {
    GroupBoxNewOperation operation = new GroupBoxNewOperation(getTypeName(), m_declaringType, true);
    // write back members
    if (getNlsName() != null) {
  ...
  protected IStatus getStatusNameField() throws JavaModelException {
    IStatus javaFieldNameStatus = ScoutUtility.getJavaNameStatus(getTypeName(), SdkProperties.SUFFIX_GROUP_BOX);
