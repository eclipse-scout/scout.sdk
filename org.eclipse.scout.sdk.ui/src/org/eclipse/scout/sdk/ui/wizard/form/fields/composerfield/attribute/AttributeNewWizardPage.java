...
public class AttributeNewWizardPage extends AbstractWorkspaceWizardPage {
  ...
  protected void createContent(Composite parent) {
    ...
    ITypeProposal[] proposals = ScoutProposalUtility.getScoutTypeProposalsFor(ScoutTypeUtility.getAbstractTypesOnClasspath(iComposerAttribute, m_declaringType.getJavaProject()));
