...
public class DateFieldNewWizardPage extends AbstractWorkspaceWizardPage {
  ...
  public DateFieldNewWizardPage(IType declaringType) {
    ...
    setSuperType(RuntimeClasses.getSuperType(RuntimeClasses.IDateField, m_declaringType.getJavaProject()));
  ...
  public boolean performFinish(IProgressMonitor monitor, IWorkingCopyManager workingCopyManager) throws CoreException {
    DateFieldNewOperation operation = new DateFieldNewOperation(getTypeName(), m_declaringType, true);
    // write back members
    if (getNlsName() != null) {
