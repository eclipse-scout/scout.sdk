...
public class IntegerFieldNewWizardPage extends AbstractWorkspaceWizardPage {
  ...
  public IntegerFieldNewWizardPage(IType declaringType) {
    ...
    setSuperType(RuntimeClasses.getSuperType(IRuntimeClasses.IIntegerField, m_declaringType.getJavaProject()));
  ...
  public boolean performFinish(IProgressMonitor monitor, IWorkingCopyManager workingCopyManager) throws CoreException {
    IntegerFieldNewOperation operation = new IntegerFieldNewOperation(getTypeName(), m_declaringType, true);
    // write back members
    if (getNlsName() != null) {
