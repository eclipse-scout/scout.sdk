...
public class OutlineServiceNewWizard extends AbstractWorkspaceWizard {
  ...
  public OutlineServiceNewWizard(IScoutBundle serverBundle) {
    ...
    m_serviceNewWizardPage = new ServiceNewWizardPage(Texts.get("NewOutlineService"), Texts.get("CreateANewOutlineService"), ScoutSdk.getType(RuntimeClasses.IService), ScoutIdeProperties.SUFFIX_OUTLINE_SERVICE);
    ...
    public void propertyChange(PropertyChangeEvent evt) {
      if (evt.getPropertyName().equals(ServiceNewWizardPage.PROP_TYPE_NAME)) {
        ...
        if (!StringUtility.isNullOrEmpty(typeName)) {
          String prefix = typeName.replaceAll(ScoutIdeProperties.SUFFIX_OUTLINE_SERVICE + "$", "");
          TreeUtility.findNode(m_locationWizardPageRoot, NodeFilters.getByType(TYPE_SERVICE_IMPLEMENTATION)).setText(prefix + ScoutIdeProperties.SUFFIX_OUTLINE_SERVICE);
          TreeUtility.findNode(m_locationWizardPageRoot, NodeFilters.getByType(TYPE_SERVICE_INTERFACE)).setText("I" + prefix + ScoutIdeProperties.SUFFIX_OUTLINE_SERVICE);
