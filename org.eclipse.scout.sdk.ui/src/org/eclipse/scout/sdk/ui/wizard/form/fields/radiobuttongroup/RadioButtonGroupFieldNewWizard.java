...
public class RadioButtonGroupFieldNewWizard extends AbstractFormFieldWizard {

  private RadioButtonGroupFieldNewWizardPage m_page1;

  public RadioButtonGroupFieldNewWizard() {
    setWindowTitle(Texts.get("NewRadioButtonGroup"));
  }

  @Override
  public void initWizard(IType declaringType) {
    super.initWizard(declaringType);
    m_page1 = new RadioButtonGroupFieldNewWizardPage(getDeclaringType());
    addPage(m_page1);
  }
