...
public class TabBoxNewWizard extends AbstractFormFieldWizard {

  private TabBoxNewWizardPage m_page1;

  public TabBoxNewWizard() {
    setWindowTitle(Texts.get("NewTabBox"));
  }

  @Override
  public void initWizard(IType declaringType) {
    super.initWizard(declaringType);
    m_page1 = new TabBoxNewWizardPage(getDeclaringType());
    addPage(m_page1);
  }
