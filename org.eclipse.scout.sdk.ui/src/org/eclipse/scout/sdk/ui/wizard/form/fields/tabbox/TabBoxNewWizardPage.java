...
public class TabBoxNewWizardPage extends AbstractWorkspaceWizardPage {
  ...
  public TabBoxNewWizardPage(IType declaringType) {
    ...
    setSuperType(RuntimeClasses.getSuperType(IRuntimeClasses.ITabBox, m_declaringType.getJavaProject()));
  ...
  public boolean performFinish(IProgressMonitor monitor, IWorkingCopyManager workingCopyManager) throws CoreException {
    TabBoxNewOperation operation = new TabBoxNewOperation(getTypeName(), m_declaringType, true);
    // write back members
    if (getNlsName() != null) {
