...
/**
 * <h3>TabBoxNewWizardPage</h3> ...
 */
public class TabBoxNewWizardPage extends AbstractWorkspaceWizardPage {
  ...
  public TabBoxNewWizardPage(IType declaringType) {
    ...
    setTitle("New Tab Box");
    setDefaultMessage("Create a new tab box.");
  ...
  protected void createContent(Composite parent) {
    ...
    m_typeNameField.setReadOnlySuffix(ScoutIdeProperties.SUFFIX_BOX);
  ...
  public boolean performFinish(IProgressMonitor monitor, IScoutWorkingCopyManager workingCopyManager) throws CoreException {
    TabBoxNewOperation operation = new TabBoxNewOperation(m_declaringType);
  ...
  protected IStatus getStatusNameField() throws JavaModelException {
    if (StringUtility.isNullOrEmpty(getTypeName()) || getTypeName().equals(ScoutIdeProperties.SUFFIX_BOX)) {
