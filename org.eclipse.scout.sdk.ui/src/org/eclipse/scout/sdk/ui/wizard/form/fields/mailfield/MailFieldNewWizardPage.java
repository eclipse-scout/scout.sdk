...
public class MailFieldNewWizardPage extends AbstractWorkspaceWizardPage {
  ...
  public MailFieldNewWizardPage(IType declaringType) {
    ...
    setSuperType(RuntimeClasses.getSuperType(IRuntimeClasses.IMailField, m_declaringType.getJavaProject()));
  ...
  public boolean performFinish(IProgressMonitor monitor, IWorkingCopyManager workingCopyManager) throws CoreException {
    MailFieldNewOperation operation = new MailFieldNewOperation(getTypeName(), m_declaringType, true);
    // write back members
    if (getNlsName() != null) {
