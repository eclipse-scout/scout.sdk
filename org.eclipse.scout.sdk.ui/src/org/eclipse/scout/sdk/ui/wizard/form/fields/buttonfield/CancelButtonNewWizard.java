...
public class CancelButtonNewWizard extends ButtonFieldNewWizard {
  ...
  public void init(IWorkbench workbench, IStructuredSelection selection) {
    ...
    getButtonFieldNewWizardPage().setSuperType(RuntimeClasses.getSuperType(IRuntimeClasses.AbstractCancelButton, jp));
    ...
    getButtonFieldNewWizardPage().setTypeName("CancelButton");
