...
public class TableFieldNewWizard extends AbstractFormFieldWizard {

  private TableFieldNewWizardPage m_page1;

  public TableFieldNewWizard() {
    setWindowTitle(Texts.get("NewTableField"));
  }

  @Override
  public void initWizard(IType declaringType) {
    super.initWizard(declaringType);
    m_page1 = new TableFieldNewWizardPage(getDeclaringType());
    addPage(m_page1);
  }
