...
/**
 * <h3>StringFieldNewWizardPage</h3>
 */
public class StringFieldNewWizardPage extends AbstractWorkspaceWizardPage {
  ...
  public StringFieldNewWizardPage(IType declaringType) {
    ...
    setSuperType(RuntimeClasses.getSuperType(IRuntimeClasses.IStringField, m_declaringType.getJavaProject()));
