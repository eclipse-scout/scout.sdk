...
public class RadioButtonNewWizard extends AbstractInnerTypeWizard {
  ...
  public void init(IWorkbench workbench, IStructuredSelection selection) {
    ...
    m_page1 = new RadioButtonNewWizardPage(getDeclaringType());
  ...
  protected void postFinishDisplayThread() {
    ScoutSdkUi.showJavaElementInEditor(m_page1.getCreatedRadioButton(), false);
  }
}
