...
public class LabelFieldNewWizardPage extends AbstractWorkspaceWizardPage {
  ...
  public LabelFieldNewWizardPage(IType declaringType) {
    ...
    setSuperType(RuntimeClasses.getSuperType(RuntimeClasses.ILabelField, m_declaringType.getJavaProject()));
  ...
  public boolean performFinish(IProgressMonitor monitor, IWorkingCopyManager workingCopyManager) throws CoreException {
    LabelFieldNewOperation operation = new LabelFieldNewOperation(getTypeName(), m_declaringType, true);
    // write back members
    if (getNlsName() != null) {
