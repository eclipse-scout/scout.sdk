...
public class ChangeCorrectionProposal implements IJavaCompletionProposal, ICompletionProposalExtension5, ICompletionProposalExtension6 {
   ...
   * @param change
   *          the change that is executed when the proposal is applied or <code>null</code> if the change will be
   ...
   * @param document
   *          the document of the editor currently active or <code>null</code> if no editor
   *          is visible
